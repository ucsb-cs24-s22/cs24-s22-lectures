...
void test_prepend(){
    ...
    LinkedList<string> list; //empty linkedlist 
    LinkedList<int> list2; //empty linkedlist
    LinkedList<Complex> list3; //empty linkedlist
    list.prepend(TAs[0]);
    list.print();
    list.prepend(TAs[1]);
    list.print();
...
void test_copyconstructor(){
    ...
    LinkedList<string> l2 {l1}; //C++ default is used
    // LinkedList l2 = l1;
    // LinkedList l2(l1);
    l2.print();
